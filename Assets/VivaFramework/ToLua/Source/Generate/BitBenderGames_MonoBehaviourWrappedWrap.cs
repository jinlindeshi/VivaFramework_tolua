...
public class BitBenderGames_MonoBehaviourWrappedWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(BitBenderGames.MonoBehaviourWrapped), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Transform(IntPtr L)
	{
		...
		try
		{
			...
			BitBenderGames.MonoBehaviourWrapped obj = (BitBenderGames.MonoBehaviourWrapped)o;
