...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<Pathfinding.GraphNode>), factory.System_Action_Pathfinding_GraphNode);
		dict.Add(typeof(System.Func<Pathfinding.GraphNode,bool>), factory.System_Func_Pathfinding_GraphNode_bool);
		...
		DelegateTraits<System.Action<Pathfinding.GraphNode>>.Init(factory.System_Action_Pathfinding_GraphNode);
		DelegateTraits<System.Func<Pathfinding.GraphNode,bool>>.Init(factory.System_Func_Pathfinding_GraphNode_bool);
		...
		TypeTraits<System.Action<Pathfinding.GraphNode>>.Init(factory.Check_System_Action_Pathfinding_GraphNode);
		TypeTraits<System.Func<Pathfinding.GraphNode,bool>>.Init(factory.Check_System_Func_Pathfinding_GraphNode_bool);
		...
		StackTraits<System.Action<Pathfinding.GraphNode>>.Push = factory.Push_System_Action_Pathfinding_GraphNode;
		StackTraits<System.Func<Pathfinding.GraphNode,bool>>.Push = factory.Push_System_Func_Pathfinding_GraphNode_bool;
	...
	class Pathfinding_OnPathDelegate_Event : LuaDelegate
	{
		public Pathfinding_OnPathDelegate_Event(LuaFunction func) : base(func) { }
		public Pathfinding_OnPathDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Pathfinding.Path param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(Pathfinding.Path param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public Pathfinding.OnPathDelegate Pathfinding_OnPathDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Pathfinding.OnPathDelegate fn = delegate(Pathfinding.Path param0) { };
			return fn;
		}

		if(!flag)
		{
			Pathfinding_OnPathDelegate_Event target = new Pathfinding_OnPathDelegate_Event(func);
			Pathfinding.OnPathDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Pathfinding_OnPathDelegate_Event target = new Pathfinding_OnPathDelegate_Event(func, self);
			Pathfinding.OnPathDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_Pathfinding_OnPathDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Pathfinding.OnPathDelegate), L, pos);
	}

	void Push_Pathfinding_OnPathDelegate(IntPtr L, Pathfinding.OnPathDelegate o)
	{
		ToLua.Push(L, o);
	}
	...
	class Pathfinding_OnGraphDelegate_Event : LuaDelegate
	{
		...
		public void Call(Pathfinding.NavGraph param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(Pathfinding.NavGraph param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public Pathfinding.OnGraphDelegate Pathfinding_OnGraphDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Pathfinding.OnGraphDelegate fn = delegate(Pathfinding.NavGraph param0) { };
			return fn;
		}
	...
	class System_Action_Pathfinding_GraphNode_Event : LuaDelegate
	{
		public System_Action_Pathfinding_GraphNode_Event(LuaFunction func) : base(func) { }
		public System_Action_Pathfinding_GraphNode_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Pathfinding.GraphNode param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(Pathfinding.GraphNode param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<Pathfinding.GraphNode> System_Action_Pathfinding_GraphNode(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<Pathfinding.GraphNode> fn = delegate(Pathfinding.GraphNode param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_Pathfinding_GraphNode_Event target = new System_Action_Pathfinding_GraphNode_Event(func);
			System.Action<Pathfinding.GraphNode> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_Pathfinding_GraphNode_Event target = new System_Action_Pathfinding_GraphNode_Event(func, self);
			System.Action<Pathfinding.GraphNode> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_Pathfinding_GraphNode(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<Pathfinding.GraphNode>), L, pos);
	}

	void Push_System_Action_Pathfinding_GraphNode(IntPtr L, System.Action<Pathfinding.GraphNode> o)
	{
		ToLua.Push(L, o);
	}

	class System_Func_Pathfinding_GraphNode_bool_Event : LuaDelegate
	{
		public System_Func_Pathfinding_GraphNode_bool_Event(LuaFunction func) : base(func) { }
		public System_Func_Pathfinding_GraphNode_bool_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public bool Call(Pathfinding.GraphNode param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public bool CallWithSelf(Pathfinding.GraphNode param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Func<Pathfinding.GraphNode,bool> System_Func_Pathfinding_GraphNode_bool(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Func<Pathfinding.GraphNode,bool> fn = delegate(Pathfinding.GraphNode param0) { return false; };
			return fn;
		}

		if(!flag)
		{
			System_Func_Pathfinding_GraphNode_bool_Event target = new System_Func_Pathfinding_GraphNode_bool_Event(func);
			System.Func<Pathfinding.GraphNode,bool> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Func_Pathfinding_GraphNode_bool_Event target = new System_Func_Pathfinding_GraphNode_bool_Event(func, self);
			System.Func<Pathfinding.GraphNode,bool> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Func_Pathfinding_GraphNode_bool(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Func<Pathfinding.GraphNode,bool>), L, pos);
	}

	void Push_System_Func_Pathfinding_GraphNode_bool(IntPtr L, System.Func<Pathfinding.GraphNode,bool> o)
	{
		ToLua.Push(L, o);
	}
