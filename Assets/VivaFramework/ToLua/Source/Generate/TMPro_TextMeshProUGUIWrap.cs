...
public class TMPro_TextMeshProUGUIWrap
{
	...
	static int DOText(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOText");
			}
		}
		catch (Exception e)
		{
	...
	static int DOCounter(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOCounter");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGlowColor(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOGlowColor");
			}
		}
		catch (Exception e)
		{
