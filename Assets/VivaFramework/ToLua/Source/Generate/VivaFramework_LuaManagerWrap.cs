...
public class VivaFramework_LuaManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(VivaFramework.LuaManager), typeof(Manager));
	...
	static int InitStart(IntPtr L)
	{
		try
		{
			...
			VivaFramework.LuaManager obj = (VivaFramework.LuaManager)ToLua.CheckObject<VivaFramework.LuaManager>(L, 1);
			obj.InitStart();
			return 0;
		}
		catch (Exception e)
