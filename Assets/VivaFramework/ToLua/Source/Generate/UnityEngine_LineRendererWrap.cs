...
public class UnityEngine_LineRendererWrap
{
	...
	static int DORewind(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.LineRenderer.DORewind");
			}
		}
		catch (Exception e)
		{
	...
	static int DORestart(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.LineRenderer.DORestart");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGoto(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.LineRenderer.DOGoto");
			}
		}
		catch (Exception e)
		{
	...
	static int DOKill(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.LineRenderer.DOKill");
			}
		}
		catch (Exception e)
		{
	...
	static int DOComplete(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.LineRenderer.DOComplete");
			}
		}
		catch (Exception e)
		{
	...
	static int DOColor(IntPtr L)
	{
		try
		{
			...
			UnityEngine.LineRenderer obj = (UnityEngine.LineRenderer)ToLua.CheckObject(L, 1, typeof(UnityEngine.LineRenderer));
			DG.Tweening.Color2 arg0 = StackTraits<DG.Tweening.Color2>.Check(L, 2);
			DG.Tweening.Color2 arg1 = StackTraits<DG.Tweening.Color2>.Check(L, 3);
