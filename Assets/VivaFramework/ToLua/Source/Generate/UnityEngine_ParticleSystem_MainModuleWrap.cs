...
public class UnityEngine_ParticleSystem_MainModuleWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("emitterVelocity", get_emitterVelocity, set_emitterVelocity);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_emitterVelocity(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			UnityEngine.Vector3 ret = obj.emitterVelocity;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index emitterVelocity on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_emitterVelocity(IntPtr L)
	{
		object o = null;
