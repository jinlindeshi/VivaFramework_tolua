...
public class UnityEngine_UI_TextWrap
{
	...
	static int DOBlendableColor(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Text, UnityEngine.Color, float>(L, 1))
			{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Text.DOBlendableColor");
			}
		}
		catch (Exception e)
		{
	...
	static int DOText(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Text.DOText");
			}
		}
		catch (Exception e)
		{
	...
	static int DOFade(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Text, float, float>(L, 1))
			{
				UnityEngine.UI.Text obj = (UnityEngine.UI.Text)ToLua.ToObject(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Text.DOFade");
			}
		}
		catch (Exception e)
		{
	...
	static int DOCounter(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Text.DOCounter");
			}
		}
		catch (Exception e)
		{
	...
	static int DOColor(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Text.DOColor");
			}
		}
		catch (Exception e)
		{
