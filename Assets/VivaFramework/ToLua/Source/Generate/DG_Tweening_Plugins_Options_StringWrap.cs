...
public class DG_Tweening_Plugins_Options_StringWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DG.Tweening.Core.TweenerCore<string,string,DG.Tweening.Plugins.Options.StringOptions>), typeof(DG.Tweening.Tweener), "DG_Tweening_Plugins_Options_String");
