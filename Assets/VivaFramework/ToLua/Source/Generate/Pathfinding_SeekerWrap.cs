...
public class Pathfinding_SeekerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Pathfinding.Seeker), typeof(Pathfinding.VersionedMonoBehaviour));
	...
	static int GetCurrentPath(IntPtr L)
	{
		try
		{
			...
			Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
	...
	static int CancelCurrentPathRequest(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Pathfinding.Seeker.CancelCurrentPathRequest");
			}
		}
		catch (Exception e)
		{
	...
	static int RunModifiers(IntPtr L)
	{
		try
		{
			...
			Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
			Pathfinding.Seeker.ModifierPass arg0 = (Pathfinding.Seeker.ModifierPass)ToLua.CheckObject(L, 2, typeof(Pathfinding.Seeker.ModifierPass));
	...
	static int StartPath(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<Pathfinding.Path, Pathfinding.OnPathDelegate, Pathfinding.GraphMask>(L, 2))
			{
				Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
				Pathfinding.Path arg0 = (Pathfinding.Path)ToLua.ToObject(L, 2);
				Pathfinding.OnPathDelegate arg1 = (Pathfinding.OnPathDelegate)ToLua.ToObject(L, 3);
				Pathfinding.GraphMask arg2 = StackTraits<Pathfinding.GraphMask>.To(L, 4);
				Pathfinding.Path o = obj.StartPath(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				Pathfinding.GraphMask arg3 = StackTraits<Pathfinding.GraphMask>.Check(L, 5);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Pathfinding.Seeker.StartPath");
			}
		}
		catch (Exception e)
		{
	...
	static int get_drawGizmos(IntPtr L)
	{
		...
		try
		{
			...
			Pathfinding.Seeker obj = (Pathfinding.Seeker)o;
