...
---@field enabledGlobalKeywords table
---@field globalKeywords table
...
---@return int
function m:GetPassCountInSubshader(subshaderIndex) end
...
---@param tagName UnityEngine.Rendering.ShaderTagId
---@return UnityEngine.Rendering.ShaderTagId
function m:FindSubshaderTagValue(subshaderIndex, tagName) end
...
---@param name string
---@param value int
function m.SetGlobalInteger(name, value) end
...
---@param name string
---@return int
function m.GetGlobalInteger(name) end
